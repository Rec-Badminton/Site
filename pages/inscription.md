 ...
 <div class="livret">
  ...
  <div class="parent"> 
    ...
    <div class="div2">
      ...
      <a href="https://poona.ffbad.org//page.php?P=fo/menu/public/accueil/operation_promo_participant&k=Nzk2OUAyNA==" target="_blank"><img class="d-block m-auto qrcode" src="{{site.baseurl}}/assets/data/qrcode/{{ qrcode_file.name }}" alt="qrcode">
